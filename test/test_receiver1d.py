# I think this file is trash, leaving it here just in case
...
# class Test_Receiver1D(TestCase):
...
#             stream = obspy.read(self.full_path + "data/vuws/1.dat")
#         trace = stream[0]
#         expected = trace.data
...
#         with warnings.catch_warnings():
#             warnings.filterwarnings("ignore")
#             stream = obspy.read(self.full_path + "data/denise/v1.2_x.su.shot1")
#         trace = stream[0]
#         expected = trace.data
#         received = utprocess.Receiver1D.from_trace(trace).timeseries.amp
#         self.assertArrayEqual(expected, received)
